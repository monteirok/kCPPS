...
export default class PlayerCard extends BaseContainer {
    ...
    constructor(scene, x, y) {
       ...
       // this.badge_vip;
		...
		// badge_vip
        //const badge_vip = scene.add.image(-149, -224, "main", "badge/vip");
		//this.add(badge_vip);
        ...
        **************************************************************************************************************************************************************/
		...
		//this.badge_vip = badge_vip;
		this.badge_member = badge_member;
		this.badge_lines_lines = badge_lines_lines;
		this.badge_ribbon = badge_ribbon;
		this.badge_star = badge_star;
    ...
    _showCard(penguin, items = penguin) {
		...
		// if the user's nickname is null, use their username, otherwise use their nickname
		if (penguin.nickname == "" || penguin.nickname == null) {
            usernameText = penguin.username;
        }
        else {
            usernameText = penguin.nickname;
        }
		...
		/*if (penguin.rank < 2) {
            // user is a not a member, set badge to star
            this.badge_member.visible = false
			this.badge_lines_lines.visible = false
			this.stripes.visible = false
			this.badge_ribbon.visible = false
			this.badge_star.visible = false
			
			this.badge_vip.visible = true
        }
		else {
			// user is a member, set badge to member
            this.badge_member.visible = true
			this.badge_lines_lines.visible = true
			this.stripes.visible = true
			this.badge_ribbon.visible = true
			this.badge_star.visible = true
			
			this.badge_vip.visible = false
		}*/
        ...
        this.updateStripes(penguin.rank)
    ...
    **************************************/
    ...
    updateStripes(rank) {
        ...
        if (rank > 2) {
            // user is a moderator, set frame (num stripes) to 4
            frame = 4;
        }
        else {
            // user is not a moderator, set frame to 0
            frame = 0
        }
