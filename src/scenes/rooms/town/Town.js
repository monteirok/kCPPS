...
export default class Town extends RoomScene {
    ...
    constructor() {
        ...
        this.roomTriggers = {
            ...
            'beta1': () => this.triggerItem(18),
            'beta2': () => this.triggerItem(18)
        }
    ...
    _create() {
        ...
        // betabox1
        const betabox1 = this.add.image(758, 407, "town", "betabox");

        // betabox2
        const betabox2 = this.add.image(942, 726, "town", "betabox");

        // lists
        const sort = [fg, box_2, box_1, box_3, chair_2, chair_1, table_1, table_2, canopy, canopy_stars, canopy_lights, betabox2, betabox1];
